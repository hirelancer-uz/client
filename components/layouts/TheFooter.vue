...
<script>
import Ndc from "@/components/icons/ndc.vue";
import FooterTelegram from "@/components/icons/footer-telegram.vue";
import FooterInstagram from "@/components/icons/footer-instagram.vue";
