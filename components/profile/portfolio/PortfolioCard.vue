    ...
    >
      <div class="modal__header px-[120px] pt-[46px] pb-[24px]">
        ...
        <div class="modal__header-right">
          <button
            class="border border-solid border-main-color bg-bg-grey px-[10px] rounded-[6px] text-main-color text-base flex h-[37px] items-center gap-[6px]"
...
import PortfolioCard2 from "./PortfolioCard2.vue";
export default {
  props: ["portfolio", "portfolios", "freelancer"],
  data() {
    return { visibleButtons: [], visible: false };
  },
  computed: {
    dateFormat() {
