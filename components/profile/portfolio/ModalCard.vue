  ...
  <div class="portfolio-card rounded-lg overflow-hidden cursor-pointer">
    <div class="image h-[270px] relative">
      ...
      <img
        ...
        alt=""
      />
      <div class="absolute right-[14px] top-[14px] flex gap-[12px] xl:hidden">
        <div
    ...
    <div
      class="body px-4 pt-3 pb-4 flex rounded-b-lg flex-col gap-[6px] border-[0] border-t-0 border-b border-x border-solid border-grey-8 xl:p-[12px]"
    >
