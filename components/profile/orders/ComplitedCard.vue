<template lang="html">
  ...
  >
    <div>
      <div class="card">
        <div class="image w-[80px] h-[80px] relative xl:w-[66px] xl:h-[66px]">
          <!-- <img v-if="order?.selected_request?.freelancer?.avatar" class="w-full h-full object-cover" :src="order?.selected_request?.freelancer?.avatar" alt="" /> -->
          ...
          <span
            ...
            v-if="order?.selected_request?.freelancer?.approved"
            ><svg
        ...
        <div class="body flex flex-col justify-between xl:w-[70%] xl:gap-[8px] gap-3">
          <div class="flex justify-between">
            ...
            <p
              :class="{ online: order?.selected_request?.freelancer?.online }"
              class="text-[14px] text-grey-24 flex gap-[4px] items-center xl:hidden"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="6"
    ...
    <div class="pt-4 border-[0] border-t border-solid border-grey-light mt-4">
      <h4 class="text-[20px] font-medium text-black xl:text-base">
        {{ order?.name }}
      </h4>
    </div>
  </div>
