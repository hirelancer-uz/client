<template lang="html">
  <div class="portfolios flex flex-col gap-6 xl:gap-4">
    <div class="flex justify-between">
      <h1
        class="text-black text-[24px] font-semibold xl:text-base xl:flex xl:justify-between xl:w-full"
      >
        {{ $store.state.translations["profile.stats"] }}
    ...
    <div
      class="list statistics-list grid grid-cols-3 gap-4 xl:grid-cols-2 xl:gap-2"
    >
