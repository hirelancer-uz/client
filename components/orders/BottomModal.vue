      ...
      <div class="max-w-[1200px] mx-auto pt-[80px] xl:pt-3 grid-container h-full">
        ...
        <div class="form flex flex-col gap-[26px] xl:gap-10">
          ...
          <div class="buttons flex justify-end gap-4 xl:flex-col-reverse">
            <button
              @click="handleOk"
              class="px-[24px] w-[168px] items-center border border-solid rounded-[8px] xl:rounded-xl h-[52px] border-grey-24 flex justify-center text-base xl:text-[14px] text-grey-64 font-medium"
            >
              Отмена
            </button>
            <button
              @click="submitForm"
              class="px-6 gap-2 items-center border border-solid rounded-[8px] xl:rounded-xl h-[52px] border-blue bg-blue flex justify-center text-base xl:text-[14px] text-white font-medium"
            >
              Отправить заявку
              <svg
