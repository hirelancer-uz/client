      ...
      <div class="flex flex-col gap-4">
        ...
        <div class="flex gap-8 flex-col items-center">
          ...
          <div class="flex flex-col items-center w-full">
            <h4 class="text-black text-[20px] font-semibold">
              Siz haqiqatdan buyurtmani bekor qilmoqchimisiz?
            </h4>
            <p class="text-base text-grey-64 mt-2">
              Agar buyurtmani bekor qilsangiz bu buyurtmani davom ettira olmaysiz
            </p>
            <span
              class="reyting rounded-[15px] px-6 py-[10px] text-light-red text-base mx-auto mt-3"
            >
              Vash reyting upadyot na -16 ballov
            </span>
            <div class="px-4 py-4 rounded-[16px] bg-bg-grey w-full mt-4">
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <button
            @click="$emit('submit')"
            class="h-[54px] items-center w-full flex justify-center gap-2 border border-solid border-light-red bg-light-red rounded-[8px] text-base font-medium text-white"
          >
            Ha, albatta
          </button>
        </div>
