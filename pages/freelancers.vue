      ...
      <div class="2xl:container mx-auto">
        <div class="title items-center xl:hidden grider">
          <h2 class="text-black text-[32px] font-semibold titler">
            Frilanserlar
            <span>{{ totalPage.toLocaleString() }} результатов</span>
          </h2>
          <div class="button grid header gap-4 items-center">
            ...
            <button
              ...
              class="h-[60px] w-[204px] flex justify-center items-center bg-white rounded-[12px] text-base font-medium text-blue border-[1px] border-blue border-solid buttoner"
            >
              Buyurtma qoshish
            </button>
            <button
